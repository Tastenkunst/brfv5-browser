...
import { drawCircle, drawTexture }          from '../utils/utils__canvas.js'
...
export const setTextureExporterSize = (width, height) => {

  log(_name + ': setTextureExporterSize:', width, height)
